                                        ...
                                        new Aui.Form.FieldSet({
                                            ...
                                            items: [
                                                new Aui.Form.Field.Container({
                                                    ...
                                                    items: [
                                                        new Aui.Form.Field.Text({
                                                            label: (await this.getText('admin.columns.receiver')),
                                                            name: 'name',
                                                        }),
                                                        new Aui.Form.Field.Text({
                                                            label: (await this.getText('admin.columns.receiveNumber')),
                                                            name: 'cellphone',
                                                        }),
                                                    ],
                                                }),
                                        ...
                                        new Aui.Form.FieldSet({
                                            ...
                                            items: [
                                                new Aui.Form.Field.Container({
                                                    ...
                                                    items: [
                                                        new Aui.Form.Field.Text({
                                                            label: (await this.getText('admin.columns.sender')),
                                                            name: 'sender',
                                                        }),
                                                        new Aui.Form.Field.Text({
                                                            label: (await this.getText('admin.columns.senderNumber')),
                                    ...
                                    handler: async (button) => {
                                        ...
                                        if (results.success == true) {
                                            Aui.Message.show({
                                                ...
                                                handler: async () => {
                                                    const contacts = Aui.getComponent('messages-contacts');
                                                    if (contacts !== null) {
